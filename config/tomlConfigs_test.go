...
func TestConfigs(t *testing.T) {
	...
	expectedConfig := Config{
		...
		DharitrI: DharitrIConfig{
			NetworkAddress:               "https://devnet-gateway.dharitri.com",
			MultisigContractAddress:      "drt1qqqqqqqqqqqqqpgqzyuaqg3dl7rqlkudrsnm5ek0j3a97qevd8sslwctuh",
			SafeContractAddress:          "drt1qqqqqqqqqqqqqpgqtvnswnzxxz8susupesys0hvg7q2z5nawrcjqjxhwlw",
			PrivateKeyFile:               "keys/dharitri.pem",
			IntervalToResendTxsInSeconds: 60,
			GasMap: DharitrIGasMapConfig{
				Sign:                   8000000,
			...
			AntifloodConfig: chainConfig.AntifloodConfig{
				...
				Topic: chainConfig.TopicAntifloodConfig{
					...
					MaxMessages: []chainConfig.TopicMaxMessagesConfig{
						{
							Topic:             "EthereumToDharitrI_join",
							NumMessagesPerSec: 100,
						},
						{
							Topic:             "EthereumToDharitrI_sign",
							NumMessagesPerSec: 100,
						},
					},
				},
...
[DharitrI]
    NetworkAddress = "https://devnet-gateway.dharitri.com" # the network address
    MultisigContractAddress = "drt1qqqqqqqqqqqqqpgqzyuaqg3dl7rqlkudrsnm5ek0j3a97qevd8sslwctuh" # the dharitri address for the bridge contract
    SafeContractAddress = "drt1qqqqqqqqqqqqqpgqtvnswnzxxz8susupesys0hvg7q2z5nawrcjqjxhwlw" # the dharitri address for the safe contract
    PrivateKeyFile = "keys/dharitri.pem" # the path to the pem file containing the relayer dharitri wallet
...
[P2P]
    ...
    [P2P.AntifloodConfig]
        ...
        [P2P.AntifloodConfig.Topic]
            ...
            MaxMessages = [{ Topic = "EthereumToDharitrI_join", NumMessagesPerSec = 100 },
                           { Topic = "EthereumToDharitrI_sign", NumMessagesPerSec = 100 }]
...
func TestScCallsExecutorConfigs(t *testing.T) {
	...
	expectedConfig := ScCallsModuleConfig{
		ScProxyBech32Address:            "drt1qqqqqqqqqqqqqpgqnef5f5aq32d63kljld8w5vnvz4gk5sy9hrrqhr6vyw",
...
[Filter]
	...
	AllowedDrtAddresses = ["*"]     # execute SC calls to all DrT contracts
