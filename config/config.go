...
// DharitrIConfig represents the DharitrI Config parameters
type DharitrIConfig struct {
	NetworkAddress                  string
	MultisigContractAddress         string
	SafeContractAddress             string
	PrivateKeyFile                  string
...
// ProxyConfig represents the configuration for the DharitrI proxy
...
// DharitrIGasMapConfig represents the gas limits for DharitrI operations
type DharitrIGasMapConfig struct {
	Sign                   uint64
