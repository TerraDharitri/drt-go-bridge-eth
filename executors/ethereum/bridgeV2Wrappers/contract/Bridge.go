...
//
// Solidity: function getStatusesAfterExecution(uint256 batchNonceNumbatETH) view returns(uint8[])
func (_Bridge *BridgeCaller) GetStatusesAfterExecution(opts *bind.CallOpts, batchNonceNumbatETH *big.Int) ([]uint8, error) {
	var out []interface{}
	err := _Bridge.contract.Call(opts, &out, "getStatusesAfterExecution", batchNonceNumbatETH)
...
//
// Solidity: function getStatusesAfterExecution(uint256 batchNonceNumbatETH) view returns(uint8[])
func (_Bridge *BridgeSession) GetStatusesAfterExecution(batchNonceNumbatETH *big.Int) ([]uint8, error) {
	return _Bridge.Contract.GetStatusesAfterExecution(&_Bridge.CallOpts, batchNonceNumbatETH)
}

// GetStatusesAfterExecution is a free data retrieval call binding the contract method 0xdb626c2d.
//
// Solidity: function getStatusesAfterExecution(uint256 batchNonceNumbatETH) view returns(uint8[])
func (_Bridge *BridgeCallerSession) GetStatusesAfterExecution(batchNonceNumbatETH *big.Int) ([]uint8, error) {
	return _Bridge.Contract.GetStatusesAfterExecution(&_Bridge.CallOpts, batchNonceNumbatETH)
}
...
//
// Solidity: function wasBatchExecuted(uint256 batchNonceNumbatETH) view returns(bool)
func (_Bridge *BridgeCaller) WasBatchExecuted(opts *bind.CallOpts, batchNonceNumbatETH *big.Int) (bool, error) {
	var out []interface{}
	err := _Bridge.contract.Call(opts, &out, "wasBatchExecuted", batchNonceNumbatETH)
...
//
// Solidity: function wasBatchExecuted(uint256 batchNonceNumbatETH) view returns(bool)
func (_Bridge *BridgeSession) WasBatchExecuted(batchNonceNumbatETH *big.Int) (bool, error) {
	return _Bridge.Contract.WasBatchExecuted(&_Bridge.CallOpts, batchNonceNumbatETH)
}

// WasBatchExecuted is a free data retrieval call binding the contract method 0x84aa1ad0.
//
// Solidity: function wasBatchExecuted(uint256 batchNonceNumbatETH) view returns(bool)
func (_Bridge *BridgeCallerSession) WasBatchExecuted(batchNonceNumbatETH *big.Int) (bool, error) {
	return _Bridge.Contract.WasBatchExecuted(&_Bridge.CallOpts, batchNonceNumbatETH)
}
...
//
// Solidity: function executeTransfer(address[] tokens, address[] recipients, uint256[] amounts, uint256[] depositNonces, uint256 batchNonceNumbatETH, bytes[] signatures) returns()
func (_Bridge *BridgeTransactor) ExecuteTransfer(opts *bind.TransactOpts, tokens []common.Address, recipients []common.Address, amounts []*big.Int, depositNonces []*big.Int, batchNonceNumbatETH *big.Int, signatures [][]byte) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "executeTransfer", tokens, recipients, amounts, depositNonces, batchNonceNumbatETH, signatures)
}

// ExecuteTransfer is a paid mutator transaction binding the contract method 0x51db0518.
//
// Solidity: function executeTransfer(address[] tokens, address[] recipients, uint256[] amounts, uint256[] depositNonces, uint256 batchNonceNumbatETH, bytes[] signatures) returns()
func (_Bridge *BridgeSession) ExecuteTransfer(tokens []common.Address, recipients []common.Address, amounts []*big.Int, depositNonces []*big.Int, batchNonceNumbatETH *big.Int, signatures [][]byte) (*types.Transaction, error) {
	return _Bridge.Contract.ExecuteTransfer(&_Bridge.TransactOpts, tokens, recipients, amounts, depositNonces, batchNonceNumbatETH, signatures)
}

// ExecuteTransfer is a paid mutator transaction binding the contract method 0x51db0518.
//
// Solidity: function executeTransfer(address[] tokens, address[] recipients, uint256[] amounts, uint256[] depositNonces, uint256 batchNonceNumbatETH, bytes[] signatures) returns()
func (_Bridge *BridgeTransactorSession) ExecuteTransfer(tokens []common.Address, recipients []common.Address, amounts []*big.Int, depositNonces []*big.Int, batchNonceNumbatETH *big.Int, signatures [][]byte) (*types.Transaction, error) {
	return _Bridge.Contract.ExecuteTransfer(&_Bridge.TransactOpts, tokens, recipients, amounts, depositNonces, batchNonceNumbatETH, signatures)
}
