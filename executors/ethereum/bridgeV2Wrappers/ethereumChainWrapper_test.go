...
import (
	...
	"github.com/TerraDharitri/drt-go-bridge-eth/executors/ethereum/bridgeV2Wrappers/mock"
...
func TestEthClientWrapper_GetStatusesAfterExecution(t *testing.T) {
	...
	handlerCalled := false
	args.MultiSigContract = &mock.MultiSigContractStub{
		GetStatusesAfterExecutionCalled: func(opts *bind.CallOpts, batchNonceDharitrIETH *big.Int) ([]uint8, error) {
			handlerCalled = true
			return nil, nil
		},
	}
