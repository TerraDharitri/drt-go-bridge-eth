...
const drtTestAddress1 = "drt1qqqqqqqqqqqqqpgqk839entmk46ykukvhpn90g6knskju3dtanaqhn7ee8"
const drtTestAddress2 = "drt1qqqqqqqqqqqqqpgqptqsx2llrwh4phaf42lwwxez2hzeulxwanaq4zpt46"
...
func TestNewPendingOperationFilter(t *testing.T) {
	...
	t.Run("denied drt list contains wildcard should error", func(t *testing.T) {
		t.Parallel()

		cfg := createTestConfig()
		cfg.DeniedDrtAddresses = []string{"	*  "}

		filter, err := NewPendingOperationFilter(cfg, testLog)
		assert.Nil(t, filter)
		assert.ErrorIs(t, err, errUnsupportedMarker)
		assert.Contains(t, err.Error(), "on item at index 0 in list DeniedDrtAddresses")
	})
	...
	t.Run("allowed drt list contains empty string should error", func(t *testing.T) {
		t.Parallel()

		cfg := createTestConfig()
		cfg.AllowedDrtAddresses = append(cfg.AllowedDrtAddresses, "	 ")

		filter, err := NewPendingOperationFilter(cfg, testLog)
		assert.Nil(t, filter)
		assert.ErrorIs(t, err, errUnsupportedMarker)
		assert.Contains(t, err.Error(), "on item at index 1 in list AllowedDrtAddresses")
	})
	...
	t.Run("invalid address in AllowedDrtAddresses should error", func(t *testing.T) {
		t.Parallel()

		cfg := createTestConfig()
		cfg.AllowedDrtAddresses = append(cfg.AllowedDrtAddresses, "invalid address")
	...
	t.Run("invalid address in DeniedDrtAddresses should error", func(t *testing.T) {
		t.Parallel()

		cfg := createTestConfig()
		cfg.DeniedDrtAddresses = append(cfg.DeniedDrtAddresses, "invalid address")
	...
	t.Run("should work", func(t *testing.T) {
		...
		cfg := createTestConfig()
		cfg.AllowedEthAddresses = append(cfg.AllowedDrtAddresses, ethTestAddress1)
		cfg.DeniedEthAddresses = append(cfg.DeniedEthAddresses, ethTestAddress1)
		cfg.AllowedDrtAddresses = append(cfg.AllowedDrtAddresses, drtTestAddress1)
		cfg.DeniedDrtAddresses = append(cfg.DeniedDrtAddresses, drtTestAddress1)
		filter, err := NewPendingOperationFilter(cfg, testLog)
...
func TestPendingOperationFilter_ShouldExecute(t *testing.T) {
	...
	t.Run("callData.To is not a valid Drt address should return false", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("eth address", func(t *testing.T) {
		...
		callData.To, _ = data.NewAddressFromBech32String(drtTestAddress1)
		...
		t.Run("is not denied but not allowed should return false", func(t *testing.T) {
			...
			cfg.AllowedDrtAddresses = nil

			filter, _ := NewPendingOperationFilter(cfg, testLog)
			assert.False(t, filter.ShouldExecute(callData))
		})
	})
	t.Run("drt address", func(t *testing.T) {
		t.Parallel()
		...
		t.Run("is denied should return false", func(t *testing.T) {
			...
			cfg := createTestConfig()
			cfg.DeniedDrtAddresses = []string{drtTestAddress1}
			cfg.AllowedDrtAddresses = []string{drtTestAddress1}

			filter, _ := NewPendingOperationFilter(cfg, testLog)
			assert.False(t, filter.ShouldExecute(callData))

			cfg.AllowedDrtAddresses = []string{"*"}
			filter, _ = NewPendingOperationFilter(cfg, testLog)
			assert.False(t, filter.ShouldExecute(callData))
		})
		t.Run("is not denied but allowed should return true", func(t *testing.T) {
		...
		t.Run("is not denied but not allowed should return false", func(t *testing.T) {
			...
			cfg := createTestConfig()
			cfg.AllowedDrtAddresses = []string{drtTestAddress2}
			cfg.AllowedTokens = nil
