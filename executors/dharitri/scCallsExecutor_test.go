...
import (
	...
	testCrypto "github.com/TerraDharitri/drt-go-bridge-eth/testsCommon/crypto"
...
var testCodec = &testsCommon.TestDharitrICodec{}

func createMockArgsScCallExecutor() ArgsScCallExecutor {
	return ArgsScCallExecutor{
		ScProxyBech32Address:            "drt1qqqqqqqqqqqqqpgqk839entmk46ykukvhpn90g6knskju3dtanaqhn7ee8",
		Proxy:                           &interactors.ProxyStub{},
		Codec:                           &testsCommon.DharitriCodecStub{},
...
func createTestProxySCCompleteCallData(token string) parsers.ProxySCCompleteCallData {
	...
	callData.To, _ = data.NewAddressFromBech32String("drt1qqqqqqqqqqqqqpgqnf2w270lhxhlj57jvthxw4tqsunrwnq0anaqxf6k2d")
...
func TestScCallExecutor_Execute(t *testing.T) {
	...
	t.Run("decoder errors, should error", func(t *testing.T) {
		...
		args.Codec = &testsCommon.DharitriCodecStub{
	...
	t.Run("should work", func(t *testing.T) {
		...
		args.NonceTxHandler = &testsCommon.TxNonceHandlerV2Stub{
			...
			SendTransactionCalled: func(ctx context.Context, tx *transaction.FrontendTransaction) (string, error) {
				...
				assert.Nil(t, err)
				assert.Equal(t, "drt1qqqqqqqqqqqqqpgqk839entmk46ykukvhpn90g6knskju3dtanaqhn7ee8", tx.Receiver)
