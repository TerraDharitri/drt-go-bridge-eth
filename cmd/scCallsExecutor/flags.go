...
var (
	...
	networkAddress = cli.StringFlag{
		...
		Usage: "The network address (gateway) to be used. Example: 'https://testnet-explorer.dharitri.org'",
	}
	...
	// privateKeyFile is the DharitrI private key file used to issue transaction for the SC calls
	privateKeyFile = cli.StringFlag{
		Name:  "private-key-file",
		Usage: "The DharitrI private key file used to issue transaction for the SC calls",
	}
)
