...
import (
	...
	ethereumClient "github.com/TerraDharitri/drt-go-bridge-eth/clients/ethereum"
	...
	"github.com/TerraDharitri/drt-go-bridge-eth/cmd/migration/disabled"
	...
	"github.com/TerraDharitri/drt-go-bridge-eth/executors/ethereum/bridgeV2Wrappers"
	"github.com/TerraDharitri/drt-go-bridge-eth/executors/ethereum/bridgeV2Wrappers/contract"
...
func createInternalComponentsWithBatchCreator(cfg config.MigrationToolConfig) (*internalComponents, error) {
	...
	multisigAddress, err := data.NewAddressFromBech32String(cfg.DharitrI.MultisigContractAddress)
	if err != nil {
		return nil, err
	}

	safeAddress, err := data.NewAddressFromBech32String(cfg.DharitrI.SafeContractAddress)
	if err != nil {
		return nil, err
	}
	...
	drtDataGetter, err := dharitri.NewDRTClientDataGetter(argsDRTClientDataGetter)
	if err != nil {
		return nil, err
	}
