...
const (
	...
	// MetricLastQueriedDharitrIBlockNumber represents the metric used to store the last DharitrI block number that was
	// fetched from the DharitrI client
	MetricLastQueriedDharitrIBlockNumber = "dharitri last queried block number"

	// MetricDharitrIClientStatus represents the metric used to store the status of the DharitrI client
	MetricDharitrIClientStatus = "dharitri client status"

	// MetricLastDharitrIClientError represents the metric used to store the last encountered error from the DharitrI client
	MetricLastDharitrIClientError = "dharitri client last encountered error"
...
var PersistedMetrics = []string{MetricNumBatches, MetricNumEthClientRequests, MetricNumEthClientTransactions,
	MetricLastQueriedEthereumBlockNumber, MetricLastQueriedDharitrIBlockNumber, MetricEthereumClientStatus,
	MetricDharitrIClientStatus, MetricLastEthereumClientError, MetricLastDharitrIClientError, MetricLastBlockNonce}
...
const (
	...
	// DharitrIClientStatusHandlerName is the DharitrI client status handler name
	DharitrIClientStatusHandlerName = "dharitri-client"
)
