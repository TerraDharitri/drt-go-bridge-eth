# DharitrI<->Eth Bridge
The relayer code implemented in go that uses the smart contracts and powers the bridge between DharitrI and Ethereum.

Smart contracts for both blockchains:
- https://github.com/dharitri/drt-rs-sc-bridge-eth
- https://github.com/dharitri/drt-bridge-eth-sc-sol
...
Please see the [documentation](https://docs.dharitri.com) for more details on the DharitrI project.
