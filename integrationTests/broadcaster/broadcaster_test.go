...
import (
	...
	mockRoleProviders "github.com/TerraDharitri/drt-go-bridge-eth/testsCommon/roleProviders"
	crypto "github.com/TerraDharitri/drt-go-chain-crypto"
	chainConfig "github.com/TerraDharitri/drt-go-chain/config"
	chainP2P "github.com/TerraDharitri/drt-go-chain/p2p"
...
func TestNetworkOfBroadcastersShouldPassTheSignatures(t *testing.T) {
	...
	roleProvider := &mockRoleProviders.DharitrIRoleProviderStub{
...
func createBroadcaster(
	...
	args := p2p.ArgsBroadcaster{
		...
		DharitrIRoleProvider: roleProvider,
