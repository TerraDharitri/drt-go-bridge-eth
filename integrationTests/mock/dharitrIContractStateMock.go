...
type dharitrIProposedStatus struct {
	BatchId  *big.Int
	Statuses []byte
}

type dharitrIProposedTransfer struct {
	BatchId   *big.Int
	Transfers []Transfer
}
...
// DharitrIPendingBatch -
type DharitrIPendingBatch struct {
	Nonce              *big.Int
	DharitrIDeposits []DharitrIDeposit
}

// DharitrIDeposit -
type DharitrIDeposit struct {
...
// dharitrIContractStateMock is not concurrent safe
type dharitrIContractStateMock struct {
	*tokensRegistryMock
	proposedStatus                   map[string]*dharitrIProposedStatus   // store them uniquely by their hash
	proposedTransfers                map[string]*dharitrIProposedTransfer // store them uniquely by their hash
	...
	pendingBatch                     *DharitrIPendingBatch
	quorum                           int
	lastExecutedEthBatchId           uint64
	lastExecutedEthTxId              uint64

	ProposeMultiTransferDcdtBatchCalled func()
}

func newDharitrIContractStateMock() *dharitrIContractStateMock {
	mock := &dharitrIContractStateMock{
...
// Clean -
func (mock *dharitrIContractStateMock) cleanState() {
	mock.proposedStatus = make(map[string]*dharitrIProposedStatus)
	mock.proposedTransfers = make(map[string]*dharitrIProposedTransfer)
	mock.signedActionIDs = make(map[string]map[string]struct{})
	mock.performedAction = nil
	mock.pendingBatch = nil
}

func (mock *dharitrIContractStateMock) processTransaction(tx *transaction.FrontendTransaction) {
	dataSplit := strings.Split(string(tx.Data), "@")
	funcName := dataSplit[0]
	switch funcName {
	case "proposeDcdtSafeSetCurrentTransactionBatchStatus":
		mock.proposeDcdtSafeSetCurrentTransactionBatchStatus(dataSplit, tx)

		return
	case "proposeMultiTransferDcdtBatch":
		mock.proposeMultiTransferDcdtBatch(dataSplit, tx)
		return
	case "sign":
...
func (mock *dharitrIContractStateMock) proposeDcdtSafeSetCurrentTransactionBatchStatus(dataSplit []string, _ *transaction.FrontendTransaction) {
	status, hash := mock.createProposedStatus(dataSplit)

	mock.proposedStatus[hash] = status
}

func (mock *dharitrIContractStateMock) proposeMultiTransferDcdtBatch(dataSplit []string, _ *transaction.FrontendTransaction) {
	transfer, hash := mock.createProposedTransfer(dataSplit)

	mock.proposedTransfers[hash] = transfer

	if mock.ProposeMultiTransferDcdtBatchCalled != nil {
		mock.ProposeMultiTransferDcdtBatchCalled()
	}
}

func (mock *dharitrIContractStateMock) createProposedStatus(dataSplit []string) (*dharitrIProposedStatus, string) {
	buff, err := hex.DecodeString(dataSplit[1])
	if err != nil {
		panic(err)
	}
	status := &dharitrIProposedStatus{
	...
	if len(status.Statuses) != len(mock.pendingBatch.DharitrIDeposits) {
		panic(fmt.Sprintf("different number of statuses fetched while creating proposed status: provided %d, existing %d",
			len(status.Statuses), len(mock.pendingBatch.DharitrIDeposits)))
	}
...
func (mock *dharitrIContractStateMock) createProposedTransfer(dataSplit []string) (*dharitrIProposedTransfer, string) {
	buff, err := hex.DecodeString(dataSplit[1])
	if err != nil {
		panic(err)
	}
	transfer := &dharitrIProposedTransfer{
		BatchId: big.NewInt(0).SetBytes(buff),
	}
...
func (mock *dharitrIContractStateMock) processVmRequests(vmRequest *data.VmValueRequest) (*data.VmValuesResponseData, error) {
	if vmRequest == nil {
...
func (mock *dharitrIContractStateMock) vmRequestWasSetCurrentTransactionBatchStatusActionProposed(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
...
func (mock *dharitrIContractStateMock) vmRequestGetActionIdForSetCurrentTransactionBatchStatus(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
	args := append([]string{vmRequest.FuncName}, vmRequest.Args...) // prepend the function name so the next call will work
	_, hash := mock.createProposedStatus(args)
...
func (mock *dharitrIContractStateMock) vmRequestwasTransferActionProposed(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
	args := append([]string{vmRequest.FuncName}, vmRequest.Args...) // prepend the function name so the next call will work
...
func (mock *dharitrIContractStateMock) vmRequestGetActionIdForTransferBatch(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
	args := append([]string{vmRequest.FuncName}, vmRequest.Args...) // prepend the function name so the next call will work
	_, hash := mock.createProposedTransfer(args)
...
func (mock *dharitrIContractStateMock) vmRequestGetStatusesAfterExecution(_ *data.VmValueRequest) *data.VmValuesResponseData {
...
func (mock *dharitrIContractStateMock) sign(dataSplit []string, tx *transaction.FrontendTransaction) {
...
func (mock *dharitrIContractStateMock) performAction(dataSplit []string, _ *transaction.FrontendTransaction) {
	actionID := getBigIntFromString(dataSplit[1])
	if !mock.actionIDExists(actionID) {
...
func (mock *dharitrIContractStateMock) vmRequestWasActionExecuted(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
...
func (mock *dharitrIContractStateMock) actionIDExists(actionID *big.Int) bool {
...
func (mock *dharitrIContractStateMock) vmRequestQuorumReached(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
	actionID := getBigIntFromString(vmRequest.Args[0])
	m, found := mock.signedActionIDs[actionID.String()]
	if !found {
		return createOkVmResponse([][]byte{BoolToByteSlice(false)})
...
func (mock *dharitrIContractStateMock) vmRequestGetTokenIdForErc20Address(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
	address := common.HexToAddress(vmRequest.Args[0])

	return createOkVmResponse([][]byte{[]byte(mock.getTicker(address))})
}

func (mock *dharitrIContractStateMock) vmRequestGetErc20AddressForTokenId(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
	address := vmRequest.Args[0]

	return createOkVmResponse([][]byte{mock.getErc20Address(address).Bytes()})
}

func (mock *dharitrIContractStateMock) vmRequestGetAllStakedRelayers(_ *data.VmValueRequest) *data.VmValuesResponseData {
	return createOkVmResponse(mock.relayers)
}

func (mock *dharitrIContractStateMock) vmRequestGetLastExecutedEthBatchId(_ *data.VmValueRequest) *data.VmValuesResponseData {
	val := big.NewInt(int64(mock.lastExecutedEthBatchId))

	return createOkVmResponse([][]byte{val.Bytes()})
}

func (mock *dharitrIContractStateMock) vmRequestGetLastExecutedEthTxId(_ *data.VmValueRequest) *data.VmValuesResponseData {
	val := big.NewInt(int64(mock.lastExecutedEthTxId))

	return createOkVmResponse([][]byte{val.Bytes()})
}

func (mock *dharitrIContractStateMock) vmRequestGetCurrentPendingBatch(_ *data.VmValueRequest) *data.VmValuesResponseData {
...
func (mock *dharitrIContractStateMock) responseWithPendingBatch() *data.VmValuesResponseData {
	args := [][]byte{mock.pendingBatch.Nonce.Bytes()} // first non-empty slice
	for _, deposit := range mock.pendingBatch.DharitrIDeposits {
...
func (mock *dharitrIContractStateMock) vmRequestGetBatch(request *data.VmValueRequest) *data.VmValuesResponseData {
	if mock.pendingBatch == nil {
		return createOkVmResponse(make([][]byte, 0))
	}
...
func (mock *dharitrIContractStateMock) setPendingBatch(pendingBatch *DharitrIPendingBatch) {
	mock.pendingBatch = pendingBatch
}

func (mock *dharitrIContractStateMock) vmRequestSigned(request *data.VmValueRequest) *data.VmValuesResponseData {
...
func (mock *dharitrIContractStateMock) vmRequestIsPaused(_ *data.VmValueRequest) *data.VmValuesResponseData {
	return createOkVmResponse([][]byte{BoolToByteSlice(false)})
}

func (mock *dharitrIContractStateMock) vmRequestIsMintBurnToken(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
	address := vmRequest.Args[0]

	return createOkVmResponse([][]byte{BoolToByteSlice(mock.isMintBurnToken(address))})
}

func (mock *dharitrIContractStateMock) vmRequestIsNativeToken(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
	address := vmRequest.Args[0]

	return createOkVmResponse([][]byte{BoolToByteSlice(mock.isNativeToken(address))})
}

func (mock *dharitrIContractStateMock) vmRequestGetTotalBalances(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
	address := vmRequest.Args[0]

	return createOkVmResponse([][]byte{mock.getTotalBalances(address).Bytes()})
}

func (mock *dharitrIContractStateMock) vmRequestGetMintBalances(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
	address := vmRequest.Args[0]

	return createOkVmResponse([][]byte{mock.getMintBalances(address).Bytes()})
}

func (mock *dharitrIContractStateMock) vmRequestGetBurnBalances(vmRequest *data.VmValueRequest) *data.VmValuesResponseData {
	address := vmRequest.Args[0]

	return createOkVmResponse([][]byte{mock.getBurnBalances(address).Bytes()})
}

func (mock *dharitrIContractStateMock) vmRequestGetLastBatchId(_ *data.VmValueRequest) *data.VmValuesResponseData {
	if mock.pendingBatch == nil {
		return createOkVmResponse([][]byte{big.NewInt(0).Bytes()})
	}
