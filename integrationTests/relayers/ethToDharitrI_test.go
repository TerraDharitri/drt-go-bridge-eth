...
func TestRelayersShouldExecuteTransfersFromEthToDharitrI(t *testing.T) {
	if testing.Short() {
		t.Skip("this is not a short test")
	}

	t.Run("simple tokens transfers", func(t *testing.T) {
		testRelayersShouldExecuteTransfersFromEthToDharitrI(t, false)
	})
	t.Run("native tokens transfers", func(t *testing.T) {
		testRelayersShouldExecuteTransfersFromEthToDharitrI(t, true)
	})
}

func testRelayersShouldExecuteTransfersFromEthToDharitrI(t *testing.T, withNativeTokens bool) {
	...
	destination1 := testsCommon.CreateRandomDharitrIAddress()
	depositor1 := testsCommon.CreateRandomEthereumAddress()

	value2 := big.NewInt(222222222)
	destination2 := testsCommon.CreateRandomDharitrIAddress()
	...
	if !withNativeTokens {
		...
		dharitrIChainMock.AddTokensPair(token1Erc20, ticker1, withNativeTokens, true, zero, zero, zero)
		dharitrIChainMock.AddTokensPair(token2Erc20, ticker2, withNativeTokens, true, zero, zero, zero)
	} else {
		...
		dharitrIChainMock.AddTokensPair(token1Erc20, ticker1, withNativeTokens, true, zero, zero, value1)
		dharitrIChainMock.AddTokensPair(token2Erc20, ticker2, withNativeTokens, true, zero, zero, value2)
	}

	dharitrIChainMock.SetLastExecutedEthBatchID(batchNonceOnEthereum)
	dharitrIChainMock.SetLastExecutedEthTxId(txNonceOnEthereum)
	dharitrIChainMock.GetStatusesAfterExecutionHandler = func() []byte {
	...
	transfer := dharitrIChainMock.ProposedTransfer()
...
func TestRelayersShouldExecuteTransferFromEthToDharitrIHavingTxsWithSCcalls(t *testing.T) {
	if testing.Short() {
		t.Skip("this is not a short test")
	}
	...
	t.Run("correct SC call", func(t *testing.T) {
		...
		testRelayersShouldExecuteTransferFromEthToDharitrIHavingTxsWithSCcalls(t, testArgs)
	})
...
func testRelayersShouldExecuteTransferFromEthToDharitrIHavingTxsWithSCcalls(t *testing.T, args argsForSCCallsTest) {
	safeContractEthAddress := testsCommon.CreateRandomEthereumAddress()
	...
	destination3Sc := testsCommon.CreateRandomDharitrISCAddress()
	...
	dharitrIChainMock := mock.NewDharitrIChainMock()
	dharitrIChainMock.AddTokensPair(token1Erc20, ticker1, false, true, zero, zero, zero)
	dharitrIChainMock.AddTokensPair(token2Erc20, ticker2, false, true, zero, zero, zero)
	dharitrIChainMock.AddTokensPair(token3Erc20, ticker3, false, true, zero, zero, zero)
	dharitrIChainMock.SetLastExecutedEthBatchID(batchNonceOnEthereum)
	dharitrIChainMock.SetLastExecutedEthTxId(txNonceOnEthereum)
	dharitrIChainMock.GetStatusesAfterExecutionHandler = func() []byte {
