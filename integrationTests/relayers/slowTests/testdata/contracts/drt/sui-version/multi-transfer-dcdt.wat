(module
  ...
  (import "env" "smallIntGetUnsignedArgument" (func (;16;) (type 9)))
  (import "env" "bigIntGetUnsignedArgument" (func (;17;) (type 2)))
  (import "env" "getNumArguments" (func (;18;) (type 3)))
  (import "env" "mBufferFinish" (func (;19;) (type 7)))
  (import "env" "smallIntFinishUnsigned" (func (;20;) (type 10)))
  ...
  (func (;81;) (type 15)
    i32.const 0
    call 18
    i32.store offset=142076)
  (func (;82;) (type 6) (param i32)
    local.get 0
    call 83
    call 19
    drop)
  (func (;83;) (type 7) (param i32) (result i32)
    (local i32)
    block  ;; label = @1
      local.get 0
      call 122
  ...
  (func (;102;) (type 0) (param i32 i64)
    ...
    local.get 2
    call 54)
  (func (;103;) (type 22) (param i64 i32 i32 i32 i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
    ...
    call 62
    drop)
  (func (;104;) (type 17) (param i64 i32 i32 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
          ...
          block  ;; label = @4
            block  ;; label = @5
              ...
              block  ;; label = @6
                ...
                i32.const 0
                local.get 6
                i32.store offset=142068
                i32.const 0
                i32.const 1
                i32.store8 offset=142072
                local.get 5
                i32.const 0
                i32.const 132068
                local.get 6
  ...
  (func (;121;) (type 3) (result i32)
    ...
    call 0
    i32.const -10)
  (func (;122;) (type 7) (param i32) (result i32)
    (local i32)
    local.get 0
    call 42
    local.tee 1
  ...
  (func (;123;) (type 2) (param i32 i32)
    ...
    call 26
    drop)
  (func (;124;) (type 23) (param i64 i32)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;131;) (type 2) (param i32 i32)
    ...
    call 110
    unreachable)
  (func (;132;) (type 18) (param i32 i32 i32 i32)
    block  ;; label = @1
      local.get 2
      call 133
      local.get 3
    ...
    local.get 3
    call 47)
  (func (;133;) (type 7) (param i32) (result i32)
    local.get 0
    call 134)
  ...
  (func (;136;) (type 7) (param i32) (result i32)
    local.get 0
    i32.const -25
    call 25
    drop
  ...
  (func (;138;) (type 2) (param i32 i32)
    ...
    local.get 1
    call 127)
  (func (;139;) (type 20) (param i32 i32) (result i64)
    (local i32 i32 i64)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;142;) (type 4) (param i32 i32) (result i32)
    ...
    call 54
    local.get 2)
  (func (;143;) (type 20) (param i32 i32) (result i64)
    (local i32 i64)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;144;) (type 2) (param i32 i32)
    ...
    i32.add
    global.set 0)
  (func (;145;) (type 24) (param i32 i64 i64) (result i32)
    (local i32 i32)
    block  ;; label = @1
      local.get 0
      i32.load offset=88
  ...
  (func (;154;) (type 0) (param i32 i64)
    ...
    i32.add
    global.set 0)
  (func (;155;) (type 7) (param i32) (result i32)
    local.get 0
    i32.const 32
    i32.const 131463
    i32.const 8
  ...
  (global (;1;) i32 (i32.const 142112))
  (global (;2;) i32 (i32.const 142112))
  ...
  (data (;0;) (i32.const 131072) "input too long\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00argument decode error (): too few argumentstoo many argumentswrong number of argumentsMultiDCDTNFTTransferDCDTNFTTransferDCDTTransfersync resultinput too shortManagedVec index out of range.itemstorage decode error (key: .lenbad array lengthMax tx batch size must be more than 0Max tx batch block duration must be more than 0new_max_tx_batch_sizevar argsgetTokensaddRefundBatchtransfersopt_new_addresschainSpecificToUniversalMappingInvalid token or amountInvalid unwrapping contract addressInvalid bridge proxy contract addressdepositwrapTokensinvalid valueinput out of  can only be called by ownerindex out of rangepanic occurredEmpty vec")
  (data (;1;) (i32.const 132064) "8\ff\ff\ff"))
