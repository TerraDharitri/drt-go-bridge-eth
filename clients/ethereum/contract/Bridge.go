...
//
// Solidity: function getStatusesAfterExecution(uint256 batchNonceDrt) view returns(uint8[], bool isFinal)
func (_Bridge *BridgeCaller) GetStatusesAfterExecution(opts *bind.CallOpts, batchNonceDrt *big.Int) ([]uint8, bool, error) {
	var out []interface{}
	err := _Bridge.contract.Call(opts, &out, "getStatusesAfterExecution", batchNonceDrt)
...
//
// Solidity: function getStatusesAfterExecution(uint256 batchNonceDrt) view returns(uint8[], bool isFinal)
func (_Bridge *BridgeSession) GetStatusesAfterExecution(batchNonceDrt *big.Int) ([]uint8, bool, error) {
	return _Bridge.Contract.GetStatusesAfterExecution(&_Bridge.CallOpts, batchNonceDrt)
}

// GetStatusesAfterExecution is a free data retrieval call binding the contract method 0xdb626c2d.
//
// Solidity: function getStatusesAfterExecution(uint256 batchNonceDrt) view returns(uint8[], bool isFinal)
func (_Bridge *BridgeCallerSession) GetStatusesAfterExecution(batchNonceDrt *big.Int) ([]uint8, bool, error) {
	return _Bridge.Contract.GetStatusesAfterExecution(&_Bridge.CallOpts, batchNonceDrt)
}
...
//
// Solidity: function wasBatchExecuted(uint256 batchNonceDrt) view returns(bool)
func (_Bridge *BridgeCaller) WasBatchExecuted(opts *bind.CallOpts, batchNonceDrt *big.Int) (bool, error) {
	var out []interface{}
	err := _Bridge.contract.Call(opts, &out, "wasBatchExecuted", batchNonceDrt)
...
//
// Solidity: function wasBatchExecuted(uint256 batchNonceDrt) view returns(bool)
func (_Bridge *BridgeSession) WasBatchExecuted(batchNonceDrt *big.Int) (bool, error) {
	return _Bridge.Contract.WasBatchExecuted(&_Bridge.CallOpts, batchNonceDrt)
}

// WasBatchExecuted is a free data retrieval call binding the contract method 0x84aa1ad0.
//
// Solidity: function wasBatchExecuted(uint256 batchNonceDrt) view returns(bool)
func (_Bridge *BridgeCallerSession) WasBatchExecuted(batchNonceDrt *big.Int) (bool, error) {
	return _Bridge.Contract.WasBatchExecuted(&_Bridge.CallOpts, batchNonceDrt)
}
...
//
// Solidity: function executeTransfer(address[] tokens, address[] recipients, uint256[] amounts, uint256[] depositNonces, uint256 batchNonceDrt, bytes[] signatures) returns()
func (_Bridge *BridgeTransactor) ExecuteTransfer(opts *bind.TransactOpts, tokens []common.Address, recipients []common.Address, amounts []*big.Int, depositNonces []*big.Int, batchNonceDrt *big.Int, signatures [][]byte) (*types.Transaction, error) {
	return _Bridge.contract.Transact(opts, "executeTransfer", tokens, recipients, amounts, depositNonces, batchNonceDrt, signatures)
}

// ExecuteTransfer is a paid mutator transaction binding the contract method 0x51db0518.
//
// Solidity: function executeTransfer(address[] tokens, address[] recipients, uint256[] amounts, uint256[] depositNonces, uint256 batchNonceDrt, bytes[] signatures) returns()
func (_Bridge *BridgeSession) ExecuteTransfer(tokens []common.Address, recipients []common.Address, amounts []*big.Int, depositNonces []*big.Int, batchNonceDrt *big.Int, signatures [][]byte) (*types.Transaction, error) {
	return _Bridge.Contract.ExecuteTransfer(&_Bridge.TransactOpts, tokens, recipients, amounts, depositNonces, batchNonceDrt, signatures)
}

// ExecuteTransfer is a paid mutator transaction binding the contract method 0x51db0518.
//
// Solidity: function executeTransfer(address[] tokens, address[] recipients, uint256[] amounts, uint256[] depositNonces, uint256 batchNonceDrt, bytes[] signatures) returns()
func (_Bridge *BridgeTransactorSession) ExecuteTransfer(tokens []common.Address, recipients []common.Address, amounts []*big.Int, depositNonces []*big.Int, batchNonceDrt *big.Int, signatures [][]byte) (*types.Transaction, error) {
	return _Bridge.Contract.ExecuteTransfer(&_Bridge.TransactOpts, tokens, recipients, amounts, depositNonces, batchNonceDrt, signatures)
}
